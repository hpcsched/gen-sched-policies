...
for i in xrange(0,NUM_EXPERIMENTS): #1e7  
  ...
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_hpc2n.xml -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_hpc2n.xml -wfp3 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_hpc2n.xml -unicef -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_hpc2n.xml -spt -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)  
  ...
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_hpc2n.xml -f1 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
...
ylow=[550,550,550,550,550,550,550,550]
...
#plt.show()
plt.savefig('plots/hpc2n_r_nbf.pdf', format='pdf', dpi=1000,bbox_inches='tight')
...
print('Boxplot saved in file hpc2n_r_nbf.pdf')
