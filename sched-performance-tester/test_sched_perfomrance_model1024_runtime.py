...
print('Performing scheduling performance test for the workload trace lublin_1024.\n'+
...
for i in xrange(0,NUM_EXPERIMENTS): #1e7  
  ...
  subprocess.call(['./sched-simulator-runtime xmls/plat_day.xml xmls/deployment_day_1024.xml -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
...
#plt.show()
plt.savefig('plots/model_1024_r.pdf', format='pdf', dpi=1000,bbox_inches='tight')
...
print('Boxplot saved in file model_1024_r.pdf')
