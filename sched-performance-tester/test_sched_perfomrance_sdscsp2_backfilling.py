...
#filename = "OSC-Clust-2000-3.1-cln.swf"
...
for i in xrange(0,NUM_EXPERIMENTS): #1e7  
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -wfp3 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -unicef -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -spt -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)  
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -f4 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -f3 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -f2 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_sdscsp2.xml -bf -f1 -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
...
ylow=[240,240,250,250,250,250,250,240]
...
for i in range(0,OUT_POLICIES):
  ...
  #  output = '%.1f' % (outliers[i,0])
  if MAX_OUT[i] != 0:
    plt.annotate(output, xy=(xticks[i], 280), xytext=(xticks[i]-xoffset[i], ylow[i]),
...
#plt.show()
plt.savefig('plots/sp2_bf.pdf', format='pdf', dpi=1000,bbox_inches='tight')
...
print('Boxplot saved in file sp2_bf.pdf')
